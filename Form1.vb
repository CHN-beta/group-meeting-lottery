Public Class Form1
    Private Students_ As New List(Of List(Of String)) From
    {
        ...
        {
            "万文杰", "余路成", "刘才育", "周鑫", "唐甜", "娄亚筱", "张恩铭", "张梦琦", "朱玲俐",
        ...
        New List(Of String) From
        {
            "刘辉强", "宿一曼", "封辉", "张思晴", "张润涵", "李昊天", "杨仁琪", "林梓淇",
            "梁雁彤", "翁小蒙", "莫仕弟", "陈子涵", "陈豪飞", "马修益"
        },
        New List(Of String) From
        {
            "任思豪", "刘世林", "刘启霖", "刘敏", "刘文博", "刘源 ", "刘金华", "危永平", "叶晓芳", "叶颖",
            "吴世明", "周博语", "周江鹏", "宋欣格", "廖桂敏", "张姝卿", "张宗南",
            "张文琴", "张晨昊", "张灵辉", "张耀宗", "张艺腾", "张裕祥", "曹硕", "曾国清", "李彦君",
            "李文翔", "李欣如", "李洪树", "杨镇泽", "林旺康", "柳梦宇", "王必成", "王曼", "王颖萌", "程可扬",
            "程安琪", "程舒仪", "蒋中升", "蓝进肾", "詹永萍", "赖麒鸿", "赵志国", "郑一帆", "郭叁育",
            "陈垚", "陈玮健", "陈紫怡", "陈阳", "马梦薇", "高扬钧", "黄健", "龚彬", "侯功涛"
        }
    }
